...
function importSave(imported = undefined, forced = false) {
	...
	if(imported=="flavor"){//你个肮脏的黑客,居然来偷看答案
		if(confirm("你解开了第二阶段的谜题,恭喜!如果你要继续,点击确定")) answer = prompt("第三阶段谜面:这是一首贺年诗,填填空吧!     元日 宋 王安石 -------,-------.-------,-------. 那我要问你了:如果 屠 = 1天,苏 = 2天;春风送暖 = 旧符;除去的一岁 + 日期(4位) + 变老 + 变老 + 长大 + 变老 + 长大 = 新桃.这首诗的答案是什么呢?也许答案就在这首诗之中呢?(注:解此谜题得先完成速通)")
		if(!(answer==undefined)) {
			confirm("请加 QQ 2067479591 验证答案,在聊天界面发送/验证答案 你的答案")
		}
		return
	}
	try {
